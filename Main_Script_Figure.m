...
%Add legend to border position figure.
figure(2)
...
%% Add vline to border position figure for average density plot.
figure(2)
hold on
...
%% Density/Force Profile Snapshots.
f = find(~cellfun(@isempty,position_array));
f_end = f(end);
position_array = position_array(1:f_end);
clf;
