%% Invasion Speed (as a function of parameters) - b (instant death) (delete extras after use)
'Start'
clear all;
...
death_count = zeros(length(b),tests);
speed_ave = zeros(length(b),1);
death_ave = zeros(length(b),1);
...
%% Invasion Speed (as a function of parameters) - b (gradual death)
'Start'
clear all;
...
%% Invasion Speed (as a function of parameters) - k1 (gradual death)
'Start'
clear all;
